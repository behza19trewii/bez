...
# ------------------------- Utilities -------------------------
def load_data(path_csv = r"F:\sell\data.csv", path_json='data.json'):
    """تلاش می‌کند ابتدا CSV و سپس JSON را بارگذاری کند. اگر هیچ فایلی نبود، دادهٔ ساختگی تولید می‌کند.
